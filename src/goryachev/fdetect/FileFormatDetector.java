...
import goryachev.fdetect.format.MatcherFORM;
import goryachev.fdetect.format.MatcherFTyp;
import goryachev.fdetect.format.MatcherMicrosoft;
import goryachev.fdetect.format.MatcherNetpbm;
import goryachev.fdetect.format.MatcherPICT;
import goryachev.fdetect.format.MatcherRAW;
import goryachev.fdetect.format.MatcherRIFF;
import goryachev.fdetect.format.MatcherTIFF;
import goryachev.fdetect.format.MatcherWM;
import goryachev.fdetect.format.MatcherZip;
import java.io.File;
